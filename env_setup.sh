...
netns()
{
	...
	ip netns exec ns_tx ip addr add dev cx5if1 fe80::1/10
	...
	ip netns exec ns_tx ip addr add dev cx5if1 fe80::4/10
...
xdp-net()
{
	...
	nmcli conn modify "Wired connection 2" ipv6.addresses "fe80::2/10"
	nmcli conn modify "Wired connection 2" ipv6.method manual
	...
	nmcli conn modify "Wired connection 2" ipv6.addresses "fe80::3/10"
	nmcli conn modify "Wired connection 2" ipv6.method manual
